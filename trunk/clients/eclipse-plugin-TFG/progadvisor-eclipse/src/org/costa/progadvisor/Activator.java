package org.costa.progadvisor;

import java.io.File;

import org.costa.progadvisor.console.CostabsShellCommand;
import org.costa.progadvisor.listeners.PartListener;
import org.costa.progadvisor.listeners.ResourceChangeListener;
...
public class Activator extends AbstractUIPlugin {
	...
	public void start(BundleContext context) throws Exception {
		...
		System.out.println("Vamos al liio con la nueva version...");
		...
		CostabsShellCommand.COSTABS_EXECUTABLE_PATH = exe.getAbsolutePath() + File.separator;
		//Runtime.getRuntime().exec("chmod +x " + CostabsShellCommand.COSTABS_EXECUTABLE_PATH + "*");
		
		/*String cmd[] = { "bash", "-c", "chmod +x " + CostabsShellCommand2.COSTABS_EXECUTABLE_PATH + "*" };
