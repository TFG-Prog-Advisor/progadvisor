...
public class PreferenceConstants {
	...
	public static final String PSIZE_ABST = "Size norm";
	public static final String PCOST_MODEL = "Cost model";
	public static final String PCOST_CENTER = "Cost center";
	public static final String PDEBUG_MODE = "Debugging mode";
	public static final String PASYMPTOTIC = "Asymptotic bounds";
